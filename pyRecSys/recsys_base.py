...
class RecSysBase(BaseEstimator, RegressorMixin, metaclass=ABCMeta):
    """
    ABC class (Abstract base class) for all recommender models.
    ...
    def predict(self, X: pd.DataFrame, bound_ratings: bool = True) -> list:
        ...
        Args:
            X {pandas DataFrame} -- Dataframe containing columns user_id and item_id
